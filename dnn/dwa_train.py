...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--index",
        dest="index",           
        default=['number_dynamic_obstalces', 'robot_radius', 'average_linear_velocity', 'average_obstalce_size', 'num_static_obstacles', 'corridor_width', 'distance_avg', 'distance_variance', 'robot_max_speed']

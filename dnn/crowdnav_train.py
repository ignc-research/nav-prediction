...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store",
        dest="train_csv",
        default=f"dataset/crowdnav.csv",
    ...
    parser.add_argument(
        "--index",
        dest="index",           
        default=['number_dynamic_obstalces','map_size','corridor_width','num_static_obstacles', 'height','robot_radius','distance_variance','num_obs_cv2','iterations','max_entropy']      
    )  
    parser.add_argument(
        "--selection",
        dest="selection",
